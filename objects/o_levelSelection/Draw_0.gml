if (!instance_exists(o_characterSelection))
{
    ...
    draw_sprite_ext(s_characterSelection, 0, -room_width * 0.15 + lerp(54, 0, tileY / room_height), -room_height + tileY, 1, 1, 0, c_white, 1);
    draw_sprite_ext(s_characterSelection, 0, -room_width * 0.15 + lerp(0, -54, tileY / room_height), tileY, 1, 1, 0, c_white, 1);
}
