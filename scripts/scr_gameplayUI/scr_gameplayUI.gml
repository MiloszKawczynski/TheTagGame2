...
function scr_makeStaminaBar()
{
	...
	{					
		draw_sprite_part_ext(s_staminaBar, 0, 0, 0, 80, 60, posX, posY, scaleX, scaleY, c_white, alpha);
		draw_sprite_part_ext(s_staminaBar, 1, 0, 0, 80 * value, 60, posX, posY, scaleX, scaleY, color, alpha);
	}
