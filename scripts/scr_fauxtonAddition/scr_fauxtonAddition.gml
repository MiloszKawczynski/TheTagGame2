...
function draw_sprite_3d_in_game(sprite, image, xx, yy, zz, xrotation, yrotation, zrotation, xscale, yscale, zscale, shader = shd_gmdefault, uniforms = undefined, arguments = [], enable_lighting = false, rotation = 0)
{
	if (global.debugIsGravityOn)
	{
		draw_sprite_3d(sprite, image, xx, yy, zz, xrotation, yrotation, zrotation, xscale, yscale, zscale, true, shader, uniforms, arguments, enable_lighting, rotation);
	}
	else
	{
		draw_sprite_3d(sprite, image, xx, yy, zz, xrotation + Camera.Pitch, yrotation, zrotation + 90 - Camera.Angle,  xscale, yscale, zscale, false, shader, uniforms, arguments, enable_lighting, rotation);
	}
}