function createUI()
{
	...
	with(ui)
	{
		...
		chaseBarGroup.addComponent(-1.2, -0.25, leftPlayerGroup);
		chaseBarGroup.addComponent(1.2, -0.25, rightPlayerGroup);
		...
		leftPlayerGroup.setProperties(0.15, 0.15);
		rightPlayerGroup.setProperties(0.15, 0.15);
		
		leftPortrait.setScale(0.5, 0.5);
		rightPortrait.setScale(-0.5, 0.5);
